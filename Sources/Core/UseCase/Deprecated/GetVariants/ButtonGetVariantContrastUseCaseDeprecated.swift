//
//  ButtonGetVariantContrastUseCaseDeprecated.swift
...
struct ButtonGetVariantContrastUseCaseDeprecated: ButtonGetVariantUseCaseableDeprecated {
    ...
    func execute(
        ...
        case .ai:
            return .init(
                foregroundColor: colors.ai.onAIContainer,
                backgroundColor: backgroundColor,
                pressedBackgroundColor: colors.states.aiContainerPressed,
                borderColor: borderColor,
                pressedBorderColor: pressedBorderColor
            )
        case .alert:
