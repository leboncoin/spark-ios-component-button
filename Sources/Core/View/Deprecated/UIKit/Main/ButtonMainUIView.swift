...
@available(*, deprecated, message: "Not used anymore by SparkUIButton or SparkUIIconButton")
public class ButtonMainUIView: UIControl {
    ...
    private let viewModel: ButtonMainViewModelDeprecated
    ...
    func stateDidUpdate(_ state: ButtonStateDeprecated) {
