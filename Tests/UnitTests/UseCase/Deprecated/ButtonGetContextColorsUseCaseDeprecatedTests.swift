//
//  ButtonGetContextColorsUseCaseDeprecatedTests.swift
...
final class ButtonGetContextColorsUseCaseDeprecatedTests: XCTestCase {
    ...
    func test_execute_for_all_variant_cases() throws {
        ...
        let items = variants.map {
            let intentsMock = ButtonContextColorsDeprecated.mocked()
        ...
        for item in items {
            ...
            let getContrastUseCaseMock = ButtonGetVariantUseCaseableDeprecatedGeneratedMock()
            let getFilledUseCaseMock = ButtonGetVariantUseCaseableDeprecatedGeneratedMock()
            let getGhostUseCaseMock = ButtonGetVariantUseCaseableDeprecatedGeneratedMock()
            let getOutlinedUseCaseMock = ButtonGetVariantUseCaseableDeprecatedGeneratedMock()
            let getTintedUseCaseMock = ButtonGetVariantUseCaseableDeprecatedGeneratedMock()

            let mockedUseCase: ButtonGetVariantUseCaseableDeprecatedGeneratedMock
            ...
            let getIntentsUseCaseMock = ButtonGetContextColorsUseCaseDeprecated(
...
private struct Tester {
    ...
    static func testColorsUseCaseExecuteCalling(
        givenColorsUseCase: ButtonGetVariantUseCaseableDeprecatedGeneratedMock,
    ...
    static func testColorsProperties(
        givenColors: ButtonContextColorsDeprecated,
        getColors: GetColors
    ) throws {
        // Text Color
        try self.testColor(
...
private struct GetColors {
    ...
    let givenColors: ButtonContextColorsDeprecated
