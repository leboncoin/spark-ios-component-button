//
//  ButtonGetColorsUseCaseDeprecatedTests.swift
...
final class ButtonGetColorsUseCaseDeprecatedTests: XCTestCase {
    ...
    private lazy var contextColors: ButtonContextColorsDeprecated = {
        return .init(
...
private extension ButtonGetColorsUseCaseDeprecatedTests {
    ...
    func testExecute(
        ...
        let useCase = ButtonGetColorsUseCaseDeprecated()

        // GIVEN
        let colors = useCase.execute(
            contextColors: self.contextColors,
            isPressed: givenIsPressed
        )

        // THEN
        XCTAssertIdentical(colors.imageTintColor as? ColorTokenGeneratedMock,
                           expectedImageTintColor,
                           "Wrong imageTintColor" + errorSuffixMessage)
        XCTAssertIdentical(colors.titleColor as? ColorTokenGeneratedMock,
                           expectedTitleColor,
                           "Wrong titleColor" + errorSuffixMessage)
        XCTAssertIdentical(colors.backgroundColor as? ColorTokenGeneratedMock,
                           expectedBackgroundColor,
                           "Wrong foregroundColor" + errorSuffixMessage)
        XCTAssertIdentical(colors.borderColor as? ColorTokenGeneratedMock,
                           expectedBorderColor,
                           "Wrong foregroundColor" + errorSuffixMessage)
    }
}
