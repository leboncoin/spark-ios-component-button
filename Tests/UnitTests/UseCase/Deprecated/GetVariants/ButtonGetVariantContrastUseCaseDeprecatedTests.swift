//
//  ButtonVariantGetContrastUseCaseDeprecatedTests.swift
...
final class ButtonVariantGetContrastUseCaseDeprecatedTests: ButtonVariantUseCaseDeprecatedTests {
    ...
    func sut() -> ButtonGetVariantContrastUseCaseDeprecated {
        return ButtonGetVariantContrastUseCaseDeprecated()
    }
}
