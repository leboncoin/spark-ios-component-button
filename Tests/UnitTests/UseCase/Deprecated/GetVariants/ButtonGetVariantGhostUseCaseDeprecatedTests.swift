//
//  ButtonGetVariantGhostUseCaseDeprecatedTests.swift
...
final class ButtonGetVariantGhostUseCaseDeprecatedTests: ButtonVariantUseCaseDeprecatedTests {
    ...
    func sut() -> ButtonGetVariantGhostUseCaseDeprecated {
        return ButtonGetVariantGhostUseCaseDeprecated()
    }
}
