//
//  ButtonGetVariantFilledUseCaseDeprecatedTests.swift
...
final class ButtonGetVariantFilledUseCaseDeprecatedTests: ButtonVariantUseCaseDeprecatedTests {
    ...
    func sut() -> ButtonGetVariantFilledUseCaseDeprecated {
        return ButtonGetVariantFilledUseCaseDeprecated()
    }
}
