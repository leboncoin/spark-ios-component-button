//
//  ButtonGetVariantTintedUseCaseDeprecatedTests.swift
...
final class ButtonGetVariantTintedUseCaseDeprecatedTests: ButtonVariantUseCaseDeprecatedTests {
    ...
    func sut() -> ButtonGetVariantTintedUseCaseDeprecated {
        return ButtonGetVariantTintedUseCaseDeprecated()
    }
}
